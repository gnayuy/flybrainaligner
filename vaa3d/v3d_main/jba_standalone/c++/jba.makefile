...
#LIBS += -L. -L${V3D_MAIN}/common_lib/lib/ -L$(L_PATH) -lv3dtiff64 -lz -lv3dnewmat
LIBS += -L. -L${V3D_MAIN}/common_lib/lib/ -L$(L_PATH) -lv3dtiff -lz -lv3dnewmat
else
LIBS += -L. -L${V3D_MAIN}/common_lib/lib/ -lv3dtiff -lv3dnewmat
endif

INCLUDEDIRS += -I${V3D_MAIN}/basic_c_fun/
INCLUDEDIRS += -I${V3D_MAIN}/common_lib/include/
