...
### rigid registration
SIMMETRIC=${FINALOUTPUT}"/mi"
AFFINEMATRIX=${FINALOUTPUT}"/mi0GenericAffine.mat"
...
SIMMETRIC=${FINALOUTPUT}"/mattes"
FWDDISPFIELD=${FINALOUTPUT}"/mattes0Warp.nii.gz"
BWDDISPFIELD=${FINALOUTPUT}"/mattes0InverseWarp.nii.gz"
