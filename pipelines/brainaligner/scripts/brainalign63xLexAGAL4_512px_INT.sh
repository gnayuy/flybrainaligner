...
# templates
TAR=`readItemFromConf $CONFIGFILE "tgtFBSXIS"`
TARREF=`readItemFromConf $CONFIGFILE "REFNO"`
TARLANDMARKS=`readItemFromConf $CONFIGFILE "tgtFBSXISmarkers"`
...
TAR=${TMPLDIR}"/"${TAR}
TARLANDMARKS=${TMPLDIR}"/"${TARLANDMARKS}
ATLAS=${TMPLDIR}"/"${ATLAS}
...
echo "TAR: $TAR"
echo "TARREF: $TARREF"
echo "TARLANDMARKS: $TARLANDMARKS"
echo "ATLAS: $ATLAS"
echo "RES_X: $RES_X"
echo "RES_Y: $RES_Y"
echo "RES_Z: $RES_Z"
