...
echo "~ Executing flyrightopticlobealign_512px_INT_MT.sh "
$DIR/flyrightopticlobealign_512px_INT_MT.sh -c $CONFIG_FILE -t $TEMPLATE_DIR -k $TOOL_DIR -w $WORK_DIR -i "$SUBPP,$CHN, $SUBREF,${INPUT1_RESX}x${INPUT1_RESY}x${INPUT1_RESZ}," -e $NEURONSPP
